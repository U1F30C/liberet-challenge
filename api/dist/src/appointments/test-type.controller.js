...
let TestTypeController = class TestTypeController {
    ...
    findAll(query) {
        return this.testTypesService.findAll(query);
    }
    findById(id) {
        return this.testTypesService.findById(+id);
    }
};
__decorate([
    common_1.Get(),
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], TestTypeController.prototype, "findById", null);
TestTypeController = __decorate([
    common_1.UseGuards(jwt_auth_guard_1.JwtAuthGuard),
    common_1.Controller('test-types'),
    __metadata("design:paramtypes", [test_types_service_1.TestTypesService])
], TestTypeController);
