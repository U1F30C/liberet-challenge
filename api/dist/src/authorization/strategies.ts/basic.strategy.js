...
let BasicAuthStrategy = class BasicAuthStrategy extends passport_1.PassportStrategy(passport_http_1.BasicStrategy) {
    constructor(authService) {
        super();
        this.authService = authService;
    }
    validate(email, password) {
        return this.authService.authorizeViaBasic(email, password);
    }
};
